...
class EmojiMethods {
     ...
     */
    async getEmojis(guildId: string): Promise<TEmoji[]> {
     ...
     * | Permissions needed | condition |
     ...
     | MANAGE_EMOJIS      |    always |
     */
    async getEmoji(guildId: string, emojiId: string): Promise<TEmoji> {
     ...
     */
    async createEmoji(guildId: string, data: {name: string, image: string}): Promise<TEmoji> {
     ...
     */
    async updateEmoji(guildId: string, emojiId: string, data: {name: string}): Promise<TEmoji> {
