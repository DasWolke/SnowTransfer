...
class UserMethods {
	 ...
	 * @returns {Promise<SelfUser>} [user object](https://discord.com/developers/docs/resources/user#user-object)
	 */
	async getSelf() {
		// @ts-ignore
	 ...
	 * @returns {Promise<User>} [user object](https://discord.com/developers/docs/resources/user#user-object)
	 */
	 ...
	 * @returns {Promise<import("./Guilds").Guild[]>} Array of [partial guild objects](https://discord.com/developers/docs/resources/guild#guild-object)
	 */
	async getGuilds() {
		// @ts-ignore
	 ...
	 * @returns {Promise<import("./Channels").Channel[]>} Array of [dm channels](https://discord.com/developers/docs/resources/channel#channel-object)
	 */
	 ...
	 * @returns {Promise<import("./Channels").Channel>} [DM channel](https://discord.com/developers/docs/resources/channel#channel-object)
	 *
	 * @example
