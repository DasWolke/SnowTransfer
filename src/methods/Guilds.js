...
class GuildMethods {
     ...
     * @param {import("./Channels").Channel[]} [data.channels] - array of [channels](https://discordapp.com/developers/docs/resources/channel#channel-object-channel-structure)
     ...
     * @param {string} guildId - Id of the guild
     * @returns {Promise<import("./Channels").Channel[]>} - list of [channels](https://discordapp.com/developers/docs/resources/channel#channel-object-channel-structure)
     */
     ...
     * @returns {Promise<import("./Channels").Channel>} [channel object](https://discordapp.com/developers/docs/resources/channel#channel-object-channel-structure)
     *
     * | Permissions needed | condition |
     |--------------------|-----------:|
     ...
     * @param {string} guildId - Id of the guild
     * @returns {Promise<import("./Voices").VoiceRegion[]>} List of [voice regions](https://discordapp.com/developers/docs/resources/voice#voice-region-object)
     */
     ...
     * @param {string} guildId - Id of the guild
     * @returns {Promise<import("./Invites").Invite[]>} List of [invites](https://discordapp.com/developers/docs/resources/invite#invite-object) (with metadata)
     *
     * | Permissions needed | condition |
     |--------------------|----------:|
     | MANAGE_GUILD       |    always |
