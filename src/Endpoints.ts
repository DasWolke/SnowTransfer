...
const Endpoints = {
	...
	CHANNEL_VOICE_HANGOUT: (chanId: string) => `${Endpoints.CHANNEL(chanId)}/voice-hangout` as `${ReturnType<typeof Endpoints.CHANNEL>}/voice-hangout`,
	...
	GUILD_MESSAGES_SEARCH: (guildId: string) => `${Endpoints.GUILD(guildId)}/messages/search` as `${ReturnType<typeof Endpoints.GUILD>}/messages/search`,
