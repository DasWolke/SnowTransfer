...
export = {
	...
	SCHEDULED_EVENTS: (guildID: string) => `guilds/${guildID}/scheduled-events`,
	SCHEDULED_EVENT: (guildID: string, eventId: string) => `guilds/${guildID}/scheduled-events/${eventId}`,
	SCHEDULE_EVENT_USERS: (guildID: string, eventId: string) => `guilds/${guildID}/scheduled-events/${eventId}/users`,
